...
#ifndef _FileLoggingTracer_h
#define _FileLoggingTracer_h
...
namespace axe {
  ...
  class FileLoggingTracer : public Tracer {
  private:
    bool traceCycles;
    const Thread *thread;
    uint32_t pc;
  ...
  public:
    FileLoggingTracer(std::string fileName, bool traceCycles);
